...
- Botão "Prototipar antes de decidir" — usa `sendPrompt("Objetivos definidos. Quero prototipar a solução antes de seguir o fluxo — iniciando pm-proto.")` — pode ser feito a qualquer momento: antes ou depois do gate de viabilidade.
